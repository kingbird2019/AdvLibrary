...
import com.kingbirdle.advertistingjar.R;
import com.kingbirdle.advertistingjar.base.Base;
import com.kingbirdle.advertistingjar.base.PermissionsActivity;
import com.kingbirdle.advertistingjar.jsonbean.BaiDuAdvParam;
import com.kingbirdle.advertistingjar.jsonbean.StartParam;
import com.kingbirdle.advertistingjar.litepal.AddJingDongAdv;
import com.kingbirdle.advertistingjar.litepal.Parameter;
import com.kingbirdle.advertistingjar.litepal.PlayList;
import com.kingbirdle.advertistingjar.manager.CustomActivityManager;
import com.kingbirdle.advertistingjar.manager.ExecutorServiceManager;
import com.kingbirdle.advertistingjar.manager.ProtocolManager;
import com.kingbirdle.advertistingjar.manager.SocketManager;
import com.kingbirdle.advertistingjar.manager.ThreadManager;
import com.kingbirdle.advertistingjar.service.MonitorService;
import com.kingbirdle.advertistingjar.utils.AreaAveragingScale;
import com.kingbirdle.advertistingjar.utils.Const;
import com.kingbirdle.advertistingjar.utils.GlideUtil;
import com.kingbirdle.advertistingjar.utils.MacUtil;
import com.kingbirdle.advertistingjar.utils.NetUtil;
import com.kingbirdle.advertistingjar.utils.Plog;
import com.kingbirdle.advertistingjar.utils.SharedPreferencesUtils;
...
import static com.kingbirdle.advertistingjar.base.Base.addParameterData;
import static com.kingbirdle.advertistingjar.base.Base.checkMd5;
import static com.kingbirdle.advertistingjar.base.Base.dataQuery;
import static com.kingbirdle.advertistingjar.base.Base.fileIsExists;
import static com.kingbirdle.advertistingjar.base.Base.fileNameQuery;
import static com.kingbirdle.advertistingjar.base.Base.getActivity;
import static com.kingbirdle.advertistingjar.base.Base.getQuery;
import static com.kingbirdle.advertistingjar.base.Base.isAccessibilitySettingsOn;
import static com.kingbirdle.advertistingjar.base.Base.isFirstStart;
import static com.kingbirdle.advertistingjar.base.Base.readBaiDuShow;
import static com.kingbirdle.advertistingjar.base.Base.readIntervalTimeShow;
import static com.kingbirdle.advertistingjar.base.Base.readJingDongShow;
import static com.kingbirdle.advertistingjar.base.Base.readLocalFile;
import static com.kingbirdle.advertistingjar.base.Base.removeFile;
import static com.kingbirdle.advertistingjar.base.Base.setCount;
import static com.kingbirdle.advertistingjar.base.Base.setIntentData;
import static com.kingbirdle.advertistingjar.base.Base.showReport;
import static com.kingbirdle.advertistingjar.base.Base.showSum;
import static com.kingbirdle.advertistingjar.base.Base.timeTrigger;
import static com.kingbirdle.advertistingjar.base.Base.updateDownloadCount;
import static com.kingbirdle.advertistingjar.base.Base.updateDownloadState;
import static com.kingbirdle.advertistingjar.base.Base.updateDownloadState2;
import static com.kingbirdle.advertistingjar.base.Base.vipShowSum;
import static com.kingbirdle.advertistingjar.utils.Config.ADD_JINGDONG;
import static com.kingbirdle.advertistingjar.utils.Config.APK_CHECK;
import static com.kingbirdle.advertistingjar.utils.Config.APPID;
import static com.kingbirdle.advertistingjar.utils.Config.APPKEY;
import static com.kingbirdle.advertistingjar.utils.Config.BAIDU_IS_PLAYED;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_ELEVEN;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_FIFTEEN;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_FORTY;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_ONE;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_ONE_THOUSAND;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_TEN;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_THREE;
import static com.kingbirdle.advertistingjar.utils.Config.CONSTANT_TWO;
import static com.kingbirdle.advertistingjar.utils.Config.DELETE_PLAYED_MEDIA;
import static com.kingbirdle.advertistingjar.utils.Config.DEVICE_TIME;
import static com.kingbirdle.advertistingjar.utils.Config.DOMAIN_NAME;
import static com.kingbirdle.advertistingjar.utils.Config.DOMAIN_NAME2;
import static com.kingbirdle.advertistingjar.utils.Config.END_JINGDONG;
import static com.kingbirdle.advertistingjar.utils.Config.FILE_SAVE_URL;
import static com.kingbirdle.advertistingjar.utils.Config.GET_BAIDU_AD;
import static com.kingbirdle.advertistingjar.utils.Config.GET_REDPACKET_AMOUNT;
import static com.kingbirdle.advertistingjar.utils.Config.GET_START_PARAM;
import static com.kingbirdle.advertistingjar.utils.Config.ILLEGAL_LOGO_URR;
import static com.kingbirdle.advertistingjar.utils.Config.INITIAL_HERATBEAT;
import static com.kingbirdle.advertistingjar.utils.Config.INITIAL_IP;
import static com.kingbirdle.advertistingjar.utils.Config.INITIAL_PORT;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_APP_HOST;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_APP_ID;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_APP_KEY;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_CODE;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_CODE1;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_CODE2;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_CODE3;
import static com.kingbirdle.advertistingjar.utils.Config.JINGDONG_REPORT;
import static com.kingbirdle.advertistingjar.utils.Config.PACKAGE_NAME;
import static com.kingbirdle.advertistingjar.utils.Config.REDPACKET_AMOUNT;
import static com.kingbirdle.advertistingjar.utils.Config.ROOT_DIRECTORY_URL;
import static com.kingbirdle.advertistingjar.utils.Config.SAVE_BAIDU_LOG;
import static com.kingbirdle.advertistingjar.utils.Config.SET_DEVICE_PARAM;
import static com.kingbirdle.advertistingjar.utils.Config.START_JINGDONG;
import static com.kingbirdle.advertistingjar.utils.Config.SUCCESS;
import static com.kingbirdle.advertistingjar.utils.Config.SUCCESS2;
import static com.kingbirdle.advertistingjar.utils.Config.USER_NAME;
import static com.kingbirdle.advertistingjar.utils.Const.AD_MATERIAL_ID;
import static com.kingbirdle.advertistingjar.utils.Const.LOGO_SIZE;
import static com.kingbirdle.advertistingjar.utils.Const.QR_SIZE;
import static com.kingbirdle.advertistingjar.utils.Const.VOICE_CONTENT;
import static com.kingbirdle.advertistingjar.utils.Const.VOICE_ENABLE;
import static com.kingbirdle.advertistingjar.utils.NetUtil.isNetConnected;
import static com.kingbirdle.advertistingjar.utils.Plog.e;
import static com.kingbirdle.advertistingjar.utils.SharedPreferencesUtils.readString;
...
public class AdvertistingView extends FrameLayout {
    ...
    public String getLongitude() {
        return SharedPreferencesUtils.readString(activity, Const.LONGITUDE);
    }

    public String getLatitude() {
        return SharedPreferencesUtils.readString(activity, Const.LATITUDE);
    }
